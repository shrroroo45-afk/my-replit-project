        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <a href="https://wa.me/962776000000?text=Hello%2C%20I%20need%20a%20shipping%20quote" target="_blank" rel="noopener noreferrer"
              ...
              <a href="tel:+962776000000" className="flex items-center gap-2 px-8 py-4 border-2 border-white/20 text-white rounded-xl font-bold text-[15px] hover:bg-white/10 transition-colors">
