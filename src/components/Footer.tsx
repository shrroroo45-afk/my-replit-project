    ...
    <footer className="bg-primary text-white pb-24 md:pb-0">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <img src="/uploads/logo-avatar.png" alt="Avatar Express" loading="lazy" className="h-14 w-40 object-cover object-center rounded-lg mb-5" />
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="mailto:info@avatarexpress.net" className="flex items-center gap-2 text-[13px] text-white/75 hover:text-white transition-colors break-all"><Mail size={13} /> info@avatarexpress.net</a>
