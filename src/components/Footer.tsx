          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {[
                ...
                <a key={h} href={h} className="text-[13px] text-blue-200/50 hover:text-white transition-colors">{l}</a>
              ))}
            </div>
          </div>
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {[
                ...
                t('Door to Door', 'توصيل حتى الباب'),
                t('Customs Clearance', 'تخليص جمركي'),
                t('Logistics Solutions', 'حلول لوجستية'),
              ].map(s => (
                <a key={s} href="#services" className="text-[13px] text-blue-200/50 hover:text-white transition-colors">{s}</a>
              ))}
            </div>
          </div>
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="tel:+962776000000" className="flex items-center gap-2 text-[13px] text-blue-200/50 hover:text-white transition-colors"><Phone size={13} /> +962 77 600 0000</a>
              <a href="mailto:info@avatarexpress.jo" className="flex items-center gap-2 text-[13px] text-blue-200/50 hover:text-white transition-colors"><Mail size={13} /> info@avatarexpress.jo</a>
              <span className="flex items-center gap-2 text-[13px] text-blue-200/50"><MapPin size={13} /> {t('Amman, Jordan', 'عمان، الأردن')}</span>
              <a href="https://wa.me/962776000000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[13px] text-wa font-semibold"><MessageCircle size={13} /> {t('WhatsApp', 'واتساب')}</a>
            </div>
          </div>
        </div>
